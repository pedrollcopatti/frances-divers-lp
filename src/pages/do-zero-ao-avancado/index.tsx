      ...
      >
        ...
        >
          <Text
            ...
            color="white.500"
          >
            Essa promoção acaba em: {days} dias, {hours} horas, {minutes} min,{" "}
            {seconds} seg
          </Text>
        </Flex>
            ...
            {!isLargerThan1000 && (
              <>
                ...
                <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
                  ...
                  <DrawerContent>
                    <DrawerCloseButton />
                    <DrawerHeader>Navegue sobre a página</DrawerHeader>
        ...
        <Stack align="center" spacing="24" marginTop="7rem">
          ...
          >
            ...
            <YouTube
              ...
              title="Apresentação Francês-Divers"
              opts={opts}
              videoId="yE4UhbqZBQE"
            />
          </Stack>
        ...
        >
          ...
          >
            ...
            <Text fontSize="large">
              ...
              <strong>plantão de dúvidas e apoio pedagógico</strong> para você
              não perder tempo.
            </Text>
          </Stack>
        </Flex>
        ...
        >
          ...
          >
            ...
            <Text fontSize="large">
              Contato com o francês da vida real através de áudios nativos,
              musicas e diálogos em francês. Mais do que aprender a língua,{" "}
              <strong> você irá ter uma imersão na cultura francófona.</strong>
            </Text>
          </Stack>
          <Flex width="50%" align="center" justify="center">
        ...
        >
          <Heading
            ...
            textColor="white.500"
          >
            O que você vai ter no Francês com Francês-Divers
          </Heading>
        ...
        <Stack width="90%" marginTop="3rem" align="center" spacing="12">
          ...
          <Text width={["90%", "70%", "60%"]} fontSize="xl" textAlign="center">
            O curso é voltado para pessoas de todas as idades que estão
            iniciando do zero ou já tem um nível básico, e agora desejam
            aprender a falar francês de forma definitiva! E para quem...
          </Text>
        </Stack>
        <Grid
          marginTop="5rem"
        ...
        >
          <Text
            ...
            fontWeight="bold"
          >
            Para todos que querem aprender FRANCÊS!
          </Text>
        </Flex>
        <Stack
          id="teachers"
        ...
        >
          ...
          <Stack spacing={12} direction={isLargerThan1000 ? "row" : "column"} width={["90%", "70%", "60%"]}>
            <Depoiment path={sandra} nome="Sandra Coeli" text="Longa experiência de prática de ensino e pesquisa na aprendizagem da língua francesa. Mestra e doutora em didática do ensino de francês pela USP (Universidade de São Paulo). Enfoque da prática de ensino na comunicação para o trabalho, o estudo, viagens e todas as experiências que o francês pode proporcionar para todos."/>
            <Depoiment path={kwami} nome="Kwami Fleury" text="É NATIVO da língua e professor há + de 10 anos. Diploma em estudos literários na língua francesa; também leciona na escola de idiomas HBLS em Bruxelas (Bélgica) e está mestrando na ULB (Universidade Livre de Bruxelas)."/>
          </Stack>
          </Stack>
        <Stack
          id="depoiment"
        ...
        >
          ...
          <Text width={["90%", "70%", "60%"]} fontSize="xl" textAlign="center">
            Ouça o que nossos alunos têm a dizer sobre o curso:
          </Text>
        </Stack>
        <Grid
          templateColumns={[
        ...
        <Flex>
          ...
          >
            ...
            <Stack align="center" spacing="4" textAlign="center">
              ...
              <Text color="white.50">
                E-book Saiba o que te impede de aprender francês
              </Text>
              <Text textAlign="center" color="white.50" fontWeight="bold">
                Aulas de conversação com foco na pronúncia
              </Text>
              <Text color="white.50">
                Lista de filmes franceses para treinar seu francês o
              </Text>
              <Text color="white.50">
